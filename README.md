...
> **Active Milestone:** `Phase 28 (Document Ingestion — استقبال ملفات المهام .txt & .md كبرومبت مباشر)` 📄⚡ — مع P27 تصفح الصفحات وP26 الحذف الذري وP25 الإلغاء التفاعلي حيَّة  
> **Test Status:** `406/406 PASS (100% OK)` — Gate Exit Code 0  
...
* **Unit Tests Catalog (406 Tests):** [docs/tests/TEST_SUITE_CATALOG.md](docs/tests/TEST_SUITE_CATALOG.md)
...
```bash
# 1. Run full unit test suite (406 tests):
