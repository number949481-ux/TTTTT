...
> **Active Milestone:** `Phase 37 (Decline ➔ Resume Summary Card — فتح بطاقة ملخص الاستئناف من زر إعادة الصياغة)` 🔄 — مع P36 مسار الرفض السريع بالمحرك وP35 كشف رفض الموديل وP34 التنسيق الآمن وP33 أزرار الإجراءات السريعة وP32 استخراج باسورد الحساب وP29–P31 وP28 وP27 وP26 وP25 حيَّة  
> **Test Status:** `761/761 PASS (100% OK)` — Gate Exit Code 0  
...
## 📖 Architecture & Documentation (Dual-Wing Docs Suite)
...
* **Unit Tests Catalog (761 Tests):** [docs/tests/TEST_SUITE_CATALOG.md](docs/tests/TEST_SUITE_CATALOG.md)
...
```bash
# 1. Run full unit test suite (761 tests):
