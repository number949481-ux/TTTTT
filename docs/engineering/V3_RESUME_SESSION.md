...
3. **التحقق من سلامة الاختبارات الشاملة:**
   * شغل الأمر: `python scripts/hadith_sijil.py` وتأكد من اجتياز 369/369 اختبار بـ Exit Code 0.
...
* **Test-Before-Talk:** ممنوع إبلاغ المستخدم بنجاح أي تعديل دون تشغيل `py_compile` واختبارات الوحدة الـ 369 والتأكد من خروج Exit Code 0.
