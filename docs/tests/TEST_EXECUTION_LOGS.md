...
test_blocked_restart_rechecks_readiness_without_repeating_compact (test_auto_compact.CompactTests.test_blocked_restart_rechecks_readiness_without_repeating_compact) ... ok
...
test_short_completion_persists_due_without_immediate_compact (test_auto_compact.CompactTests.test_short_completion_persists_due_without_immediate_compact) ... ok
...
test_unverified_compact_on_receiver_sends_resume_once (test_auto_compact.CompactTests.test_unverified_compact_on_receiver_sends_resume_once) ... ok
