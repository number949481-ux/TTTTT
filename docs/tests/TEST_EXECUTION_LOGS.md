...
* **التاريخ والوقت:** `2026-09-11 13:48:33 UTC`
* **الأمر المنفذ:** `python -m unittest discover tests -v`
* **الزمن المقاس:** `3.455 ثانية`
* **النتيجة العامة:** `Ran 1085 tests — OK`
...
```text
test_cancel_precedes_pending_metadata_failure_in_sender (test_auto_compact.ApprovedCompactPolicyTests.test_cancel_precedes_pending_metadata_failure_in_sender) ... ok
test_cancellation_after_maintenance_prevents_next_account_claim (test_auto_compact.ApprovedCompactPolicyTests.test_cancellation_after_maintenance_prevents_next_account_claim) ... ok
test_completed_never_schedules_compact (test_auto_compact.ApprovedCompactPolicyTests.test_completed_never_schedules_compact) ... ok
test_completion_clear_failure_is_explicit_and_retains_real_result (test_auto_compact.ApprovedCompactPolicyTests.test_completion_clear_failure_is_explicit_and_retains_real_result) ... ok
test_cooldown_failure_returns_public_url_without_next_account (test_auto_compact.ApprovedCompactPolicyTests.test_cooldown_failure_returns_public_url_without_next_account) ... ok
test_fresh_fork_skips_only_inherited_readiness (test_auto_compact.ApprovedCompactPolicyTests.test_fresh_fork_skips_only_inherited_readiness) ... ok
test_missing_handoff_save_never_sends_work_on_another_account (test_auto_compact.ApprovedCompactPolicyTests.test_missing_handoff_save_never_sends_work_on_another_account) ... ok
test_no_next_account_keeps_maintenance_public_url (test_auto_compact.ApprovedCompactPolicyTests.test_no_next_account_keeps_maintenance_public_url) ... ok
test_same_pid_and_failed_fork_do_not_bypass_readiness (test_auto_compact.ApprovedCompactPolicyTests.test_same_pid_and_failed_fork_do_not_bypass_readiness) ... ok
test_successful_maintenance_rotates_before_work_without_credit_increment (test_auto_compact.ApprovedCompactPolicyTests.test_successful_maintenance_rotates_before_work_without_credit_increment) ... ok
test_55_second_credit_exhaustion_compacts (test_auto_compact.CompactTests.test_55_second_credit_exhaustion_compacts) ... ok
test_90_second_credit_exhaustion_compacts (test_auto_compact.CompactTests.test_90_second_credit_exhaustion_compacts) ... ok
test_absent_current_session_blocks_bypass (test_auto_compact.CompactTests.test_absent_current_session_blocks_bypass) ... ok
test_account_above_180_does_not_compact (test_auto_compact.CompactTests.test_account_above_180_does_not_compact) ... ok
test_active_generation_blocks_bypass (test_auto_compact.CompactTests.test_active_generation_blocks_bypass) ... ok
...
test_compact_uses_full_session_timeout_and_can_finish_after_180_seconds (test_auto_compact.CompactTests.test_compact_uses_full_session_timeout_and_can_finish_after_180_seconds) ... ok
test_completed_run_clears_due_without_scheduling (test_auto_compact.CompactTests.test_completed_run_clears_due_without_scheduling) ... ok
...
test_finished_compact_trailing_user_turn_rotates_and_dispatches (test_auto_compact.CompactTests.test_finished_compact_trailing_user_turn_rotates_and_dispatches) ... ok
...
test_finished_noop_on_receiver_rotates_then_sends_resume_once (test_auto_compact.CompactTests.test_finished_noop_on_receiver_rotates_then_sends_resume_once) ... ok
test_finished_noop_rotates_then_sends_original_prompt_once (test_auto_compact.CompactTests.test_finished_noop_rotates_then_sends_original_prompt_once) ... ok
...
test_identity_save_failure_stops_handoff_without_business_send (test_auto_compact.CompactTests.test_identity_save_failure_stops_handoff_without_business_send) ... ok
...
test_long_credit_after_maintenance_resumes_without_recompacting (test_auto_compact.CompactTests.test_long_credit_after_maintenance_resumes_without_recompacting) ... ok
test_low_balance_after_compact_is_skipped_and_next_account_sends_work (test_auto_compact.CompactTests.test_low_balance_after_compact_is_skipped_and_next_account_sends_work) ... ok
test_new_credit_replaces_old_deferral_and_long_credit_clears_due (test_auto_compact.CompactTests.test_new_credit_replaces_old_deferral_and_long_credit_clears_due) ... ok
...
test_owner_manifest_fresh_fork_dispatches_without_maintenance (test_auto_compact.CompactTests.test_owner_manifest_fresh_fork_dispatches_without_maintenance) ... ok
test_pending_compact_from_different_source_is_cleared (test_auto_compact.CompactTests.test_pending_compact_from_different_source_is_cleared) ... ok
...
test_post_compact_save_failure_keeps_latest_without_work_or_recompact (test_auto_compact.CompactTests.test_post_compact_save_failure_keeps_latest_without_work_or_recompact) ... ok
test_restart_fresh_fork_bypasses_inherited_wait_without_recompacting (test_auto_compact.CompactTests.test_restart_fresh_fork_bypasses_inherited_wait_without_recompacting) ... ok
...
test_schedule_write_error_preserves_credit_checkpoint_but_stops_handoff (test_auto_compact.CompactTests.test_schedule_write_error_preserves_credit_checkpoint_but_stops_handoff) ... ok
test_short_completion_clears_due_without_compact (test_auto_compact.CompactTests.test_short_completion_clears_due_without_compact) ... ok
test_stale_summary_without_finished_turn_blocks_bypass (test_auto_compact.CompactTests.test_stale_summary_without_finished_turn_blocks_bypass) ... ok
...
test_trigger_save_failure_stops_before_compact (test_auto_compact.CompactTests.test_trigger_save_failure_stops_before_compact) ... ok
test_unconfirmed_credit_in_bypass_does_not_rotate_or_send (test_auto_compact.CompactTests.test_unconfirmed_credit_in_bypass_does_not_rotate_or_send) ... ok
test_unknown_balance_after_compact_keeps_existing_no_penalty_policy (test_auto_compact.CompactTests.test_unknown_balance_after_compact_keeps_existing_no_penalty_policy) ... ok
test_unreadable_history_blocks_bypass (test_auto_compact.CompactTests.test_unreadable_history_blocks_bypass) ... ok
test_untagged_due_is_cleared_and_never_compacts (test_auto_compact.CompactTests.test_untagged_due_is_cleared_and_never_compacts) ... ok
...
test_maintenance_and_business_timeouts_use_same_full_budget (test_auto_compact.SharedCompletionTests.test_maintenance_and_business_timeouts_use_same_full_budget) ... ok
