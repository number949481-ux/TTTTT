...
> **الكتالوج الشامل:** يوثق الـ 164 فحصاً التاريخية التراكمية للمشروع + الـ **241 فحصاً النشطة محلياً** لإصدار `01.31`  
> **حالة الاختبارات النشطة:** 241/241 PASS (100% OK) — بوابة `hadith_sijil.py` بـ Exit Code 0 ⚡  

## 📊 0. المصفوفة النشطة الحالية — 01.31 (241 فحصاً / 17 ملفاً)
...
| **P22 LiveOpsReporter** | `test_p22_live_ops_reporter.py` | **20** | **شفافية الباك-إند: timeline ترمنال موقوت + رسالة تليجرام حية (throttle 4s) + سطر «⏱️ اخد X ثانية» + finish idempotent + ربط معزول في الـ worker** |
| Parity المرآة | `test_refactor_parity.py` | 11 | تطابق بايت bridge_refactor مع 01.31 |
| **الإجمالي** | **17 ملفاً** | **241** | ✅ 241/241 PASS |
