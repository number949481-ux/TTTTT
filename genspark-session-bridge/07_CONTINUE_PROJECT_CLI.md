...
## 📍 المسار
- السكريبت: `continue_project.py` (جذر الريبو) + نسخ متطابقة **بايت-ببايت** في `الحماس/` و `جديد/`
  (نسخة `جديد/` كانت متفرعة أقدم — تمت إعادة مزامنتها 2026-08-29)
- مكمّل للأداة: مخزن `gs_link_store.py` (تكملة تلقائية بدون رابط) — انظر `08_LINK_STORE.md`
