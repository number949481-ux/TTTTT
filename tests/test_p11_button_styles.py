...
_spec = importlib.util.spec_from_file_location("bridge_mod_p11", webapp_dir / "01.33_telegram_gen_bridge.py")
...
class TestColoredKeyboardsIntegration(unittest.TestCase):
    ...
    def test_10_source_has_no_invalid_style_literals(self):
        ...
        src = (webapp_dir / "01.33_telegram_gen_bridge.py").read_text(encoding="utf-8")
        import re
