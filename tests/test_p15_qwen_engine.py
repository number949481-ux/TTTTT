...
BRIDGE_PATH = os.path.join(BASE_DIR, "01.33_telegram_gen_bridge.py")
...
class TestP15VersionBump(unittest.TestCase):
    ...
    def test_15_bridge_0128_banner_and_version(self):
        self.assertIn("01.33_telegram_gen_bridge.py", BRIDGE_SRC[:1200])
    ...
    def test_16_scripts_reference_0128(self):
        ...
        self.assertIn("01.33_telegram_gen_bridge.py", gate)
        self.assertNotIn("01.27_telegram_gen_bridge.py", gate)
        self.assertIn("01.33_telegram_gen_bridge.py", rebuild)
